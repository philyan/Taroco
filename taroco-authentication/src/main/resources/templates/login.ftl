...
<div class="ui middle aligned center aligned grid">
    <div class="column transition hidden">
        <form id="form" class="ui large form" action="/authentication/form" method="post" style="border: 0">
            <div class="ui stacked segment">
                <h3 class="title"> Taroco 统一认证中心 </h3>
        ...
        <form id="form1" class="ui large form transition hidden" action="/oauth/mobile" method="post" style="border: 0;">
            <div class="ui stacked segment">
                <h3 class="title"> Taroco 统一认证中心 </h3>
                <div class="field item">
                    <div class="ui left icon input">
                        <i class="mobile icon"></i>
                        <input id="phone" name="phone" placeholder="手机号码" value="17034642111">
                    </div>
                </div>
                <div class="field item" style="height: 80px">
                    <div class="ui right action left icon input">
                        <i class="lock icon"></i>
                        <input type="text" id="code" name="code" placeholder="验证码" value="234567">
...
<div style="text-align: center">
    <a href="https://github.com/liuht777/Taroco" target="_blank">粤ICP备18027057号</a>
</div>
</body>
